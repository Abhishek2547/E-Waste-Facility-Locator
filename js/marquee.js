...
sb.type='button';sd.appendChild(sb);sb.id = 'ss'+n.id;sb.value = 'STOP'; sb.style.display= "none"; sb.onclick = function() {if (this.value == 'STOP') {clearTimeout(m[0].TO); startstopchange(m,'START');} else {mqRotate(m); startstopchange(m,'STOP');}}; n.parentNode.insertBefore(ss,n);}   
